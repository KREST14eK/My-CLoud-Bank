    ...
    if (isAdmin) {
        ...
        ['svyat', 'misha'].forEach(user => {
            ...
            section.innerHTML = `
                ...
                <button style="background:var(--primary); margin-top:5px" onclick="openAdminModal('${user}')">Таблица истории</button>
            `;
